...
public:
  virtual bool applies( const VisDQMObject &o, const VisDQMImgInfo & )
    {
      if (o.name.find( "SiStripGains" ) != std::string::npos)  return true;
      return false;
    }
  ...
  void preDrawTH2D( TCanvas *, const VisDQMObject &o )
    {
      ...
      if (o.name.find("NoMPV")==std::string::npos) obj->SetStats( kFALSE );
        ...
        if( o.name.find("TIB")!=std::string::npos) legend->AddEntry(obj,"TIB","l");
        ...
        else if ( o.name.find("TID")!=std::string::npos ) 
          {
            if ( o.name.find("TIDM")!=std::string::npos || o.name.find("TIDmi")!=std::string::npos )
                                                               ...
                                                               legend->AddEntry(obj,"TID+","l");
            else legend->AddEntry(obj,"TID","l");
          }
        else if ( o.name.find("TEC")!=std::string::npos ) 
          {
            if ( o.name.find("TECP1")!=std::string::npos )      legend->AddEntry(obj,"TEC+, thin","l");
            else if ( o.name.find("TECP2")!=std::string::npos ) legend->AddEntry(obj,"TEC+, thick","l");
            else if ( o.name.find("TECM1")!=std::string::npos ) legend->AddEntry(obj,"TEC-, thin","l");
            else if ( o.name.find("TECM2")!=std::string::npos ) legend->AddEntry(obj,"TEC-, thick","l");
            else if ( o.name.find("TECP")!=std::string::npos )  legend->AddEntry(obj,"TEC+, thick","l");
            else if ( o.name.find("TECM")!=std::string::npos )  legend->AddEntry(obj,"TEC-, thin","l");
            else if ( o.name.find("TECmi")!=std::string::npos ) legend->AddEntry(obj,"TEC-","l");
            else if ( o.name.find("TECpl")!=std::string::npos ) legend->AddEntry(obj,"TEC+","l");
            else legend->AddEntry(obj,"TEC","l");
          }
        legend->Draw();
      }
  ...
  void postDrawTH2D( TCanvas *, const VisDQMObject &o )
    {
      ...
      if( o.name.find("GainVs")!=std::string::npos )
      ...
      else if ( o.name.find("MPVvs")!=std::string::npos )
        {
          ...
          if ( o.name.find("Eta")!=std::string::npos )      xa->SetTitle("module #eta");
          else if ( o.name.find("Phi")!=std::string::npos ) xa->SetTitle("module #phi");
        }
